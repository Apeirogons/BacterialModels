...
JD: This seems to be a hybrid explanation (you say log-uniform but seem to describe something else, maybe lognormal).
...
JD: It's worth thinking about why your parameters give you such slow resource dynamics. Is it realistic?
...
JD: It would probably be good to show perturbations on a time plot with an x scale that allows you to see the dynamics better. 
