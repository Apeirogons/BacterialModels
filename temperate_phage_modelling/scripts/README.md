This folder contains the scripts used to generate all of the plots in this project. Contains all of the parameters in the project. (To re-generate the plots, run Basic.R, MOI.R, and NoPhage.R).
